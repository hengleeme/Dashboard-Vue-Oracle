...
public class UumSecurityUtils
{
    ...
    public static Long getUserId()
    {
        ...
        {
            throw new ServiceException ("获取用户ID异常", HttpResponseStatus.UNAUTHORIZED);
        }
    }
    ...
    public static Long getDeptId()
    {
        ...
        {
            throw new ServiceException ("获取部门ID异常", HttpResponseStatus.UNAUTHORIZED);
        }
    }
    ...
    public static String getUsername()
    {
        ...
        {
            throw new ServiceException ("获取用户账户异常", HttpResponseStatus.UNAUTHORIZED);
        }
    }
    ...
    public static UumLoginUser getLoginUser()
    {
        ...
        {
            throw new ServiceException ("获取用户信息异常", HttpResponseStatus.UNAUTHORIZED);
        }
    }
