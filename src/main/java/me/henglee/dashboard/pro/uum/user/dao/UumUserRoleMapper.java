 ...
 * @author ruoyi
 */
public interface UumUserRoleMapper extends BaseModifyMapper, BaseQueryMapper
{
    /**
     * 通过用户ID删除用户和角色关联
     * 
     ...
     * @return 结果
     */
    public int batchUserRole(List<UumUserRole> userRoleList);
     ...
     * @return 结果
     */
    public int deleteUserRoleInfo(UumUserRole userRole);
