package me.henglee.dashboard.pro.uum.post.dao;
 ...
 * @author ruoyi
 */
public interface UumPostMapper
{
    /**
     * 查询岗位数据集合
     * 
     ...
     * @return 结果
     */
    public List<UumPost> selectPostsByUserName(String userName);
     ...
     * @return 结果
     */
    public UumPost checkPostNameUnique(String postName);
     ...
     * @return 结果
     */
    public UumPost checkPostCodeUnique(String postCode);
}
